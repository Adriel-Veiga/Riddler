    ...
    <div className="min-h-screen bg-ink flex flex-col items-center justify-center gap-8 p-6">
      <header className="fixed top-0 left-0 right-0 flex items-center justify-between px-6 py-5">
        ...
        <button
          ...
          className="text-violet border border-violet rounded-full px-4 py-1 text-sm hover:bg-violet/10 transition-colors"
        >
          Como jogar
        </button>
      </header>
      ...
      {showHelp && (
        ...
        >
          <div
            ...
            className="bg-ink border border-violet rounded-2xl max-w-md w-full p-6 relative"
          >
            <button
              onClick={() => setShowHelp(false)}
